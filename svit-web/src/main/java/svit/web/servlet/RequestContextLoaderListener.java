 ...
 */
public class RequestContextLoaderListener implements ServletRequestListener {

    /**
     * The logger instance for this class.
     */
    private final static Logger LOGGER = LoggerFactory.getLogger(RequestContextLoaderListener.class);
