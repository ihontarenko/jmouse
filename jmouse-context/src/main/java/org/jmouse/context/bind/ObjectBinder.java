...
public interface ObjectBinder {
    ...
    /**
     * Binds a value from the given {@link DataSource} to a target {@link Bindable} type.
     *
     ...
     */
    <T> BindResult<T> bind(NamePath name, Bindable<T> bindable, DataSource source, BindCallback callback);

    /**
     * Binds a single value from the given {@link DataSource} to a target {@link Bindable} type.
     ...
     * @return a {@link BindResult} containing the bound value, or an empty result if not found
     */
    <T> BindResult<T> bindValue(NamePath name, Bindable<T> bindable, DataSource source, BindCallback callback);
