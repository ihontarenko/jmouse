...
/**
 * Defines the contract for rendering a view into a {@link Content} object.
 * <p>
 * This interface provides methods to render a view using a fully-configured
...
public interface Renderer {
    ...
    /**
     * Renders the specified view using the given evaluation context.
     *
    ...
    /**
     * Renders the specified view using a set of variables.
     * <p>
     * A new evaluation context is created for the view, and the provided variables are
    ...
    /**
     * Renders the specified view without any additional variables.
     * <p>
