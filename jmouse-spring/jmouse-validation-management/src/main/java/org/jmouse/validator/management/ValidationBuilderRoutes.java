 ...
 * {@code jmouse.validation.management.prefix} moves this one alone. The default composes to
 * {@code /jmouse/validation/api}.</p>
 *
 * <p>⚠️ A library's own corner of a URL space rather than an official-looking {@code /admin/validation}
 ...
 */
public final class ValidationBuilderRoutes {

    /** This module's own segment under the shared root. */
    public static final String SEGMENT = "/validation/api";

    /**
     * The address these answer at when nothing overrides it — {@code /jmouse/validation/api}.
     *
    ...
    public static final String PREFIX = "${jmouse.validation.management.prefix:" + DEFAULT_PREFIX + "}";

    private ValidationBuilderRoutes() {
    }
}
