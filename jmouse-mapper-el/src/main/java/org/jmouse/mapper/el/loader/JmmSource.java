...
/**
 * One {@code .jmm} document, and where it came from. 📄
 *
 ...
 */
public record JmmSource(String location, String name, String text) {
     ...
     * @return the source
     */
    public static JmmSource at(String location, String text) {
        return new JmmSource(location, nameOf(location), text);
    }
