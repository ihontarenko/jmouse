                ...
                .routes(routes -> {
                    ...
                    routes.route("VORON_LISTING")
                            ...
                            .pipeline(pipeline -> pipeline
                                    .id("voron-listing")
                                    .step("fetch-parse", new FetchParseStep("fetch-parse"))
                    ...
                    routes.route("VORON_PRODUCT")
                            ...
                            .pipeline(pipeline -> pipeline
                                    ...
                                    .step("fetch-parse", new FetchParseStep("fetch-parse"))
                                    .step("product",
                                          new VoronProductProcessor(
                                                  "body > table > tbody > tr:nth-child(2) > td > table > tbody > tr > td > table > tbody > tr:nth-child(2) > td.center_col > div.product-block > h1"))
                            )
                            .register();

                    routes.route("IMAGE_DOWNLOADER")
                            .match(hints(ImageDownloaderHint.IMAGE_DOWNLOADER))
                            .pipeline(pipeline -> pipeline
                                    .id("image-downloader")
                                    .step("image-downloader", new ImageDownloaderStep("image-downloader"))
                            )
                            .register();
                })
