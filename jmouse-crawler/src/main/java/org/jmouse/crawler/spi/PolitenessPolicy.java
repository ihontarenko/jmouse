 ...
 * {@link org.jmouse.crawler.runtime.ProcessingTask} is executed.</p>
 *
...
public interface PolitenessPolicy {
    ...
    /**
     * Determine the earliest instant at which a request to the given URL
     ...
     */
    Instant eligibleAt(URI url, Instant now);
}
