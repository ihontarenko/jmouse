 ...
 * the {@link Ordered} interface if the object implements it. If no priority information
...
public final class Sorter {
     ...
     * <ol>
     *   <li>Checking if the object is a {@link Class} annotated with {@code @Priority}.</li>
     *   <li>Checking if the object implements {@link Ordered}.</li>
    ...
    public static final class PriorityComparator implements Comparator<Object> {
        ...
        /**
         * Extracts the priority of the given object.
         *
         * @param object the object whose priority will be extracted
