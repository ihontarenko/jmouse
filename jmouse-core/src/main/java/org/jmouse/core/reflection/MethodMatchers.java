...
public class MethodMatchers {
    ...
    /**
     * 🧪 Matcher for synthetic executables.
     *
     * <p>Matches when {@link Executable#isSynthetic()} is {@code true} —
     * i.e. methods/constructors generated by the compiler (not declared in source).</p>
     *
     * @return matcher that checks if an {@link Executable} is synthetic
     */
    public static Matcher<Executable> isSynthetic() {
        return Executable::isSynthetic;
    }

    /**
     * 🌉 Matcher for bridge methods.
     *
     * <p>Matches when {@link Method#isBridge()} is {@code true} —
     * typically compiler-generated methods for generics covariance.</p>
     *
     * @return matcher that checks if a {@link Method} is a bridge method
     */
    public static Matcher<Method> isBridge() {
