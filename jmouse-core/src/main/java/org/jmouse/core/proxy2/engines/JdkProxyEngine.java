package org.jmouse.core.proxy2.engines;

import org.jmouse.core.matcher.Matcher;
import org.jmouse.core.proxy2.api.*;
...
public final class JdkProxyEngine implements ProxyEngine {
    ...
    public boolean supports(ProxyDefinition<?> definition) {
        return definition.targetClass().isInterface() || !definition.extraIfaces().isEmpty();
    }
    ...
    public <T> T createProxy(ProxyDefinition<T> definition) {
        ...
        interfaces.addAll(definition.extraIfaces());
