...
//        for (Resource r : fileSystemLoader.loadResources("local:jmouse-framework/jmouse-common/src/main/resources/")) {
//            System.out.println(r.getName());
//        }
//
//        System.out.println(
//                new String(
//                        fileSystemLoader.getResource("local:jmouse-framework/jmouse-common/src/main/resources/META-INF/package.txt")
