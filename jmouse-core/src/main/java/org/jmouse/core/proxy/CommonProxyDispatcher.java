 ...
 * </ul>
 */
public final class CommonProxyDispatcher implements ProxyDispatcher {

    private final static Logger LOGGER = LoggerFactory.getLogger(CommonProxyDispatcher.class);
