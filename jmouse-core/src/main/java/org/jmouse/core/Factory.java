 ...
 * <p>
 * This interface allows encapsulating structured creation logic, making it useful in contexts
 * where dependency injection, lazy initialization, or configurable instantiation is required.
 * </p>
 *
 * @param <T> the type of structured this factory creates
 */
@FunctionalInterface
public interface Factory<T> {
     ...
     * @param <T>      the type of the created structured
