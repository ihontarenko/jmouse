...
/**
 * Performs introspection of Java class fields, capturing metadata such as name, annotations, and type information.
 *
 * <p>Typical usage:</p>
 * <pre>{@code
...
public class FieldIntrospector extends AnnotatedElementIntrospector<FieldData, FieldIntrospector, Field, FieldDescriptor> {
    ...
    /**
     * Performs a complete introspection including annotations, name, and type information.
     *
     * @return current introspector instance
     */
    @Override
